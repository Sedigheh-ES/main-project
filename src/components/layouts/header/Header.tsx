      ...
      <div className=" container flex items-center justify-between py-4 border-b border-b-[#E5E5E5]">
        ...
        <ul className="hidden lg:flex gap-5 cursor-pointer">
          <li className="flex gap-2 cursor-pointer ">
                      <IconBox icon={'icon-user'} size={24} title={'Account'} link={'#'} hideTitleOnMobile={true} titleClassName={"text-gray-500"} />
          </li>
         
          <li className="flex gap-2 cursor-pointer">
          <IconBox icon={'icon-shopping-cart'} size={24} title={'Card'} link={'#'}  hideTitleOnMobile={true} badge={2} titleClassName={"text-gray-500"}/>         
          </li>
        </ul>
