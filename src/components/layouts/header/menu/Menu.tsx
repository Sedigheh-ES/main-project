...
export function Menu() {
    ...
    return (
        <>
            {/* Brows all category */}
            <div id="all_categpries" onClick={categoryMenuClickHandler} className="hidden relative w-[250px] h-[50px] bg-[#3BB77E] rounded-[5px] border border-gray-200 lg:flex justify-center items-center gap-2 cursor-pointer">
                ...
                {/* All Categories Menu */}
                <div id="all_categories_box" onClick={categoryBodyClickHandler} className={`${showCategoryMenu ? 'flex' : 'hidden'} bg-white w-[500px] h-auto border absolute left-0 top-16 rounded-[10px] border-[#BCE3C9] p-2.5 z-10`}>
